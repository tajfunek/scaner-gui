function visualize(pk, path) {
	...
	function showVisual(pk) {
		...
		if(document.getElementById("canvas-" + pk) == null) {
			...
			button_cancel.classList.add("button-visual");
			button_cancel.classList.add("button-visual-red");
			button_cancel.innerHTML = "Cancel";
			button_cancel.id = "cancel_visual-" + pk;
			button_cancel.style.width = "5em";
			...
			button_res.addEventListener("click", function(event){
				...
				button_div.insertBefore(input, button_cancel);
				button_div.insertBefore(button_enter, button_cancel);
